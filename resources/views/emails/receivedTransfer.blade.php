...
<body>
    ...
    <a href="https://mainwh.apsoft.com.ph/printTransferRequest?request_number={{$details['request_number']}}">https://mainwh.apsoft.com.ph/printTransferRequest?request_number={{$details['request_number']}}</a>
    <br><br>
