    ...
    <div class="modal-content">
        ...
        <div class="modal-body" style="background-color: white; color: black;">
            ...
            <div class="form-inline" style="margin-left: 5px;">
                ...
                <input class="form-control form-control-sm" style="width: 200px; margin-right: 10px;" name="aim_item_code_details" id="aim_item_code_details" maxlength="100" placeholder="Please enter item code" required>
                <label class="form-control form-control-sm" style="width: 120px;">Item Description</label>
                <input class="form-control form-control-sm" style="width: 470px; margin-right: 10px;" name="aim_item_name_details" id="aim_item_name_details" maxlength="255" placeholder="Please enter assembled item description to proceed" required>
                <label class="form-control form-control-sm" style="width: 110px;">Minimum Stock</label>
                <input class="form-control form-control-sm" style="width: 80px; margin-right: 10px;" name="aim_minimum_details" id="aim_minimum_details" type="number" min="1" placeholder="Qty" onkeyup="if(value<1) value=1;" required>
            </div>
        </div>
        <div class="modal-header text-center" style="background-color: #0d1a80; color: white; height: 45px;">
