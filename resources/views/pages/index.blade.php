            ...
            <div class="row">
                <div class="col-sm-4" style="margin-left: 100px; margin-right: -100px;">
                    <a href="stocks" style="text-decoration:none">
                        ...
                        <div class="container" style="background-color: #0d1a80; color: white; margin-bottom: 5px; height: 48px; width: 150px; vertical-align: middle; font-size: 28px; border-radius: 30px;">
